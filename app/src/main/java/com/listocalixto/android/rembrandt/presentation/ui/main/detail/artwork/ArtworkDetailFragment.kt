...
import com.listocalixto.android.rembrandt.presentation.ui.main.MainUiEvent
...
import com.listocalixto.android.rembrandt.presentation.utility.extentions.applyContainerTransformEnterTransition
...
import com.listocalixto.android.rembrandt.presentation.utility.extentions.getInterpolator
...
import com.listocalixto.android.rembrandt.presentation.utility.extentions.showSnackbar
    ...
    fun navigateToDisplayArtwork(touchPositionX: Float, touchPositionY: Float, zoom: Float) {
        cacheKey?.let {
            mainViewModel.sendEvent(
                MainUiEvent.NavigateToDisplayImageFragment(
